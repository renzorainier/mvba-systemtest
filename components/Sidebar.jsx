  ...
  const menuGroups = [
    {
      title: null,
      items: [
        { name: 'Dashboard', href: '/portal/dashboard', icon: LayoutDashboard, allowedRoles: ['Admin', 'Sub-Admin', 'Registrar', 'Cashier'] },
      ],
    },

    {
      ...
      children: [
        ...
        { name: 'Section Management', href: '/portal/sections', icon: School, allowedRoles: ['Admin', 'Sub-Admin', 'Registrar'] },
        { name: 'Schedule Management', href: '/portal/schedules', icon: Calendar, allowedRoles: ['Admin', 'Sub-Admin', 'Registrar'] },
...

    {
      ...
      children: [
        ...
        { name: 'Student GWA Registry', href: '/portal/academics', icon: School, allowedRoles: ['Admin', 'Sub-Admin', 'Registrar'] },
        { name: 'Archived Students', href: '/portal/students/archived', icon: Archive, allowedRoles: ['Admin', 'Sub-Admin', 'Registrar'] },
      ],
    },
...

    {
      ...
      children: [
        ...
        { name: 'Help & Manual', href: '/portal/help', icon: HelpCircle, allowedRoles: ['Admin', 'Sub-Admin', 'Registrar', 'Cashier'] },
      ],
    },
  ];
  ...
  return (
    <aside className="w-72 bg-white border-r border-gray-200 flex flex-col h-screen fixed left-0 top-0 shadow-sm z-50">
      ...
      <div className="p-4 border-t border-gray-100">
        {['Admin', 'Sub-Admin'].includes(userRole) && (
