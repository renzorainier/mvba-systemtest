    ...
    <div className="min-h-screen bg-white px-4 py-6 text-slate-900 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex flex-col gap-3">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-cyan-700">Academics</p>
          <h1 className="text-3xl font-black tracking-tight md:text-4xl">Student GWA Registry</h1>
